  ...
  <div id="main">
    ...
    <header class="navbar navbar-fixed-top navbar-shadow">
      <div class="navbar-branding">
        <a class="navbar-brand" href="/yii2/backend/web/index.php">
          <b>管理</b>后台
        </a>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/yii2/frontend/web/">前端</a></li>
      </ul>
        <ul class="nav navbar-nav navbar-right">
            ...
            <div class="media">
              ...
              <div class="media-body">
                <div class="media-links">
                  用户名称 <a href="<?php echo Url::to(['site/logout']) ?>"
                  <?php if(!Yii::$app->user->isGuest){ ?>
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
               <?php if(!Yii::$app->user->isGuest){ ?>
				               <a href="<?php echo Url::to(['assignment/team']) ?>">
          ...
          <li>
            ...
            <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['assignment/personal','id'=>'0']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 查看全部</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/logout']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 查看全部</a>
                  <?php } ?>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['assignment/personal','id'=>'1']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 叶潇晗</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/logout']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 叶潇晗</a>
                  <?php } ?>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['assignment/personal','id'=>'2']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 林子淳</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/logout']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 林子淳</a>
                  <?php } ?>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
			            <a href="<?php echo Url::to(['assignment/personal','id'=>'3']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 张丽婷</a>
			                    <?php } else{?>
			            <a href="<?php echo Url::to(['site/logout']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 张丽婷</a>
			                    <?php } ?>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
			                  <a href="<?php echo Url::to(['assignment/personal','id'=>'4']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 杜金轩</a>
			                    <?php } else{?>
			                    <a href="<?php echo Url::to(['site/logout']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 杜金轩</a>
			                    <?php } ?>
          ...
          <li>
            <a class="accordion-toggle" href="">
              <span class="glyphicon glyphicon-fire"></span>
              <span class="sidebar-title">CRUD</span>
              <span class="caret"></span>
            </a>
            ...
            <ul class="nav sub-nav">
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['comment/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> comment</a>
                  <?php } else{?>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
			            <a href="<?php echo Url::to(['links/index']) ?>">
			              <span class="glyphicon glyphicon-book"></span> links</a>
			              <?php } else{?>
			            <a href="<?php echo Url::to(['site/login']) ?>">
			              <span class="glyphicon glyphicon-book"></span> links</a>
			            <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
			            <a href="<?php echo Url::to(['group/index']) ?>">
			              <span class="glyphicon glyphicon-book"></span> group</a>
			              <?php } else{?>
			              <a href="<?php echo Url::to(['site/login']) ?>">
			              <span class="glyphicon glyphicon-book"></span> group</a>
			            <?php } ?>
            ...
            <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['members/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> members</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/login']) ?>">
                  <span class="glyphicon glyphicon-book"></span> members</a>
                  <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['news/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> news</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/login']) ?>">
                  <span class="glyphicon glyphicon-book"></span> news</a>
                  <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['user/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> user</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/login']) ?>">
                  <span class="glyphicon glyphicon-book"></span> user</a>
                  <?php } ?>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['substances/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> substances</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/login']) ?>">
                  <span class="glyphicon glyphicon-book"></span> substances</a>
                  <?php } ?>
          ...
          <li class="sidebar-label pt25 pb10">成员心态</li>
          <li class="sidebar-stat">
            <a href="#projectOne" class="fs11">
              <span class="fa fa-inbox text-info"></span>
              <span class="sidebar-title text-muted">工作积极性</span>
              <span class="pull-right mr20 text-muted">233%</span>
              <div class="progress progress-bar-xs mh20 mb10">
                <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 233%">
                  <span class="sr-only">233% Complete</span>
                </div>
              </div>
            </a>
          </li>
          <li class="sidebar-stat">
            <a href="#projectOne" class="fs11">
              ...
              <span class="sidebar-title text-muted">破防程度</span>
              <span class="pull-right mr20 text-muted">114514%</span>
              <div class="progress progress-bar-xs mh20">
                <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 114514%">
                  <span class="sr-only">114514% Complete</span>
                </div>
              </div>
            </a>
          </li>
